                            ...
                            <form action="{{route('project.update',$project->id)}}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="heading1"
                                               value="{{$project->heading1}}" name="heading1" placeholder="">
                                    </div>
                                    <div class="form-group">
                                ...
                                <textarea class="summernote" name="description1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="heading2"
                                               value="{{$project->heading2}}" name="heading2" placeholder="">
                                    </div>
                                    <div class="form-group">
                                ...
                                <textarea class="summernote" name="description2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="serviceid">
                                            @foreach ($services as $service)
                                                <option
                                                    value="{{$service->id}}" {{in_array($service->id,$serviceids) ? 'selected' : ''}}>{{$service->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="date" value="{{$project->date}}"
                                               name="date" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Location</label>
                                        <input type="text" class="form-control" id="location"
                                               value="{{$project->location}}" name="location" placeholder="">
                                    </div>
                                    <div class="form-group">
